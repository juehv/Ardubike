...
void setup(void) {
  ...
  Serial.println("Enter Update Phase");
  while (millis() < 5000){
    server.handleClient();
    delay(1);
  }
  ...
  MDNS.end();
  WiFi.mode(WIFI_OFF);
  Serial.println("Update Phase END");
